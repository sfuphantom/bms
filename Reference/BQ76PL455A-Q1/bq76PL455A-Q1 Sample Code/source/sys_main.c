<<<<<<< HEAD:Reference/BQ76PL455A-Q1/bq76PL455A-Q1 Sample Code/source/sys_main.c
/**
 *
 *  @file main.c
...
/* USER CODE BEGIN (3) */
	...
	//===================================================
    uint8 senda[5] = {225, 2, 2, 208, 151};
    uint8 sendb[6] = {129, 0, 10, 0, 46, 156};
	          while(1){
	              WakePL455();
	              sciSend(scilinREG, 6, sendb);
...
/* USER CODE BEGIN (4) */
/* USER CODE END */
>>>>>>> rev_2:Reference/Passive EVM/bq76PL455A-Q1 Example Code/source/sys_main.c
