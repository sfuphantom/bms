...
extern unsigned int g_ui32SCIRxReady;
extern unsigned int g_ui32SCITxReady;
...
void delayms(uint16 ms) {
	volatile unsigned long int delayval;
	//delayval = ms * 1600;   // 1600 are about 1ms with 16MHz clock
	delayval = ms * 8400;   // 8400 are about 1ms with 80MHz clock
	while(delayval--);
}
