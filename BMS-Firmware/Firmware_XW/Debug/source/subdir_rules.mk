...
source/a_tp_sci.obj: ../source/a_tp_sci.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: ARM Compiler'
	"C:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/bin/armcl" -mv7R4 --code_state=32 --float_support=VFPv3D16 --include_path="C:/xcelw/Phantom-BMS/bms/BMS-Firmware/TEST_TWO" --include_path="C:/xcelw/Phantom-BMS/bms/BMS-Firmware/TEST_TWO/include" --include_path="C:/ti/ccsv8/tools/compiler/ti-cgt-arm_18.1.2.LTS/include" -g --diag_warning=225 --diag_wrap=off --display_error_number --enum_type=packed --abi=eabi --preproc_with_compile --preproc_dependency="source/a_tp_sci.d_raw" --obj_directory="source" $(GEN_OPTS__FLAG) "$<"
